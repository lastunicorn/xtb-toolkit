...
public class ReportDocument
{
	...
	// 			reportDocument.CashOperationsSection = ParseCashOperationsSection(worksheetPart.Worksheet, sharedStrings);
	// 		}
	//
	// 		if ((section & DocumentSection.ClosedPositions) == DocumentSection.ClosedPositions)
	// 		{
	// 			WorksheetPart worksheetPart = GetWorksheetPart(workbookPart, "Closed Positions");
	// 			reportDocument.ClosedPositionsSection = ParseClosedPositionsSection(worksheetPart.Worksheet, sharedStrings);
	// 		}
	//
	// 		return Task.FromResult(reportDocument);
	// 	}
